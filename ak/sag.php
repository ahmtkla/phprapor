<div id="column-2">
  ...
  <div class="sidebar">
    ...
    <ul class="social list">
      <li class="border">
        <a target="_blank" href="<?php echo $ayarcek["site_facebook"]; ?>"><img src="img/socials/facebook.png" alt="Facebook"/><span>KingBlog</span></a>
      </li>
      <li class="border">
        <a target="_blank" href="<?php echo $ayarcek["site_youtube"]; ?>"><img src="img/socials/youtube.png" alt="Youtube"/><span>KingBlog</span></a>
      </li>
      <li class="border">
        <a target="_blank" href="<?php echo $ayarcek["site_google"]; ?>"><img src="img/socials/google.png" alt="Google Plus"/><span>KingBlog</span></a>
      </li>
      <li style="padding-bottom:0 !important;">
        <a target="_blank" href="<?php echo $ayarcek["site_instagram"]; ?>"><img src="img/socials/instagram.png" alt="Instagram"/><span>KingBlog</span></a>
      </li>
    </ul>
  </div>
</div>
