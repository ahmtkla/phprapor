<!-- <header> -->
	...
	if (!$okunma) {
		...
		// Yazının okunma sayısını güncelle
$okunma = $db->prepare("UPDATE yazilar SET yazi_okunma = yazi_okunma + 1 WHERE yazi_seflink=?");
$okunma->execute(array($yazi_seflink));

// Okunma çerezi oluştur
setcookie($yazi_seflink, "_", time()+3600);
