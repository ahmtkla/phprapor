		...
		<header class="header">
			<div class="logo-container">
				<a href="index.php" class="logo">
					<img src="../img/king.png" height="55" width="295" alt="Mustafakartal.com Admin" style="background-color: #333; margin-top: -8px; margin-left: -12px;" />
				</a>
				...
				<div id="userbox" class="userbox">
					<a href="#" data-toggle="dropdown">
						<figure class="profile-picture">
							<img src="../img/king.png" alt="Mustafa Kartal" class="img-circle" data-lock-picture="../img/king.png" />
						</figure>
						<div class="profile-info" data-lock-name="King Blog" data-lock-email="king@blog.com">
